...
if ($_SERVER['REQUEST_URI'] == '/') {
	...
	$sideteasers[] = array('file'  => 'spiel6.jpeg', 'title' => 'Rückwärtsrolle');
	$sideteasers[] = array('file'  => 'faul3.jpeg', 'title' => 'Zu zweit');
...
if ($_SERVER['REQUEST_URI'] == '/faule-pandas') {
	...
	$sideteasers = array();
	$sideteasers[] = array('file'  => 'fress1.jpeg', 'title' => 'Lecker Bambus!');
	$sideteasers[] = array('file'  => 'spiel5.jpeg', 'title' => 'Spaß im Korb');
	$sideteasers[] = array('file'  => 'panda.jpg', 'title' => 'Süßer Panda');
...
if ($_SERVER['REQUEST_URI'] == '/fressende-pandas') {
	...
	$sideteasers = array();
	$sideteasers[] = array('file'  => 'suess2.jpeg', 'title' => 'Fauler Panda');
	$sideteasers[] = array('file'  => 'faul3.jpeg', 'title' => 'Zu zweit');
	$sideteasers[] = array('file'  => 'spiel1.jpeg', 'title' => 'Raufbolde');
